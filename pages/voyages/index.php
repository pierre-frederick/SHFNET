...
<head>
    ...
    <meta name="description" content="Voyage baroudeur shfnet">
...
<div class="container">
    <div class="article">
        <h1 class="title"> Carnet de voyages d'un baroudeur   <span class="glyphicon glyphicon-globe" aria-hidden="true"></span></h1>
        <div class="row">
            <div class="col-md-12">
                <h2>Coming soon !</h2>
            </div>
