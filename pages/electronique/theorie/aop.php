<?php
$pageArray = array();
$pageArray['title'] = "Amplificateur opérationnel";
$pageArray['description'] = "Théorie sur les AOP.";
...
<div class="container">
    <div class="article">
        <h1 class="title"><i class="fa fa-microchip"></i> <?php echo $pageArray['title'] ?></h1>
