<?php
$pageArray = array();
$pageArray['title'] = "Piles et batteries";
$pageArray['description'] = "Théorie sur les piles et batteries.";
...
<div class="container">
    <div class="article">
        <h1 class="title"><i class="fa fa-battery-half"></i> <?php echo $pageArray['title'] ?></h1>
