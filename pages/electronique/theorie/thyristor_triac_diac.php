<?php
$pageArray = array();
$pageArray['title'] = "Thyristors, diacs et triacs";
$pageArray['description'] = "Théorie sur les thyristors, diacs et triacs.";
...
<div class="container">
    <div class="article">
        <h1 class="title"><i class="fa fa-fast-forward"></i> <?php echo $pageArray['title'] ?></h1>
