...
<head>
    ...
    <meta name="description" content="shfnet theorie thyristors diac triac">
    <meta name="author" content="Pierre-Frédérick DENYS">
    <title>Thyristors, diacs et triacs</title>
    <!-- Bootstrap core CSS -->
...
<div class="container">
    <div class="article">
        ...
        <h1 class="title"><i class="fa fa-fast-forward"></i> Thyristors, diacs et triacs</h1>
