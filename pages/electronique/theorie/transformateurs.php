<?php
$pageArray = array();
$pageArray['title'] = "Transformateurs";
$pageArray['description'] = "Théorie sur les transformateurs.";
...
<div class="container">
    <div class="article">
        <h1 class="title"><i class="fa fa-ioxhost"></i> <?php echo $pageArray['title'] ?></h1>
