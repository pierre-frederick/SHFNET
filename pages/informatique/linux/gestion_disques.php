...
<div class="container">
    <div class="article">
            ...
            <h3>Disques</h3>
                <p><b>Nommage des disques :</b> Le dossier /dev/ est utilisé pour communiquer avec les partitions.</p>
                    <ul>
                        ...
                        représentant le numéro de disque (de a à z). suivi d'un chiffre pour le numéro de partition.</li>
        ...
        <h2 id="compression"> Compression et archives </h2>
            ...
            compresser en gzip, <code>-j</code> pour compresser en bz2, <code>-v</code> verbose, et <code>-f</code> pour
        ...
        <h3>Sources et liens pour en savoir plus :</h3>
            <ul>
            <li><a href="http://perso-laris.univ-angers.fr/~delanoue/iut/linux/4-%20Gestion%20des%20disques.pdf">perso-laris.univ-angers.fr</a> </li>
