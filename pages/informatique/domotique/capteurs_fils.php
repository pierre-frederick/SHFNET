...
<head>
    ...
    <title>Capteurs connectés sur le Raspi</title>
    <!-- Bootstrap core CSS -->
...
<div class="container">
    <div class="article">
        ...
        <h1 class="title"><i class="fa fa-toggle-on"></i>  Domoticz et les capteurs GPIO</h1>
        ...
        <div class="row introduction">
            <div class="col-md-12">
                <h2>Introduction</h2>
                <p>Les broches GPIO du Raspberry Pi sur lequel tourne Domoticz peuvent être utilisées pour connecter tout
