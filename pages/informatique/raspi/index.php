...
<head>
    ...
    <meta name="description" content="shfnet raspberry pi framboise raspberry">
...
<div class="container">
    <div class="article">
        <h1 class="title">   Raspberrry Pi</h1>

        <div class="row minimenu">
            <div class="col-md-6 col-md-offset-3">
                <h2>Domoticz</h2>
                <div class="list-group">
                    <a href="introduction_raspi.php" class="list-group-item ">
                        <h4 class="list-group-item-heading">Introduction au Raspberry Pi</h4>
                        <p class="list-group-item-text">Découverte du mini-ordinateur</p>
                    </a>
                </div>
