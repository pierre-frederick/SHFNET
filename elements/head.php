<head>
    ...
    <meta name="description" content="<?php echo $pageArray['description'] ?>">
    <meta name="author" content="Pierre-Frédérick DENYS">
    <title><?php echo $pageArray['title'] ?></title>

<meta property="og:title" content="<?php echo $pageArray['title'] ?>" />
<meta property="og:type" content="article" />
<meta property="og:locale" content="fr_FR" />
<meta property="og:site_name" content="shfnet.fr" />
<meta property="og:url" content="<?php echo "http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']; ?>" />
<meta property="og:image" content="<?php echo "http://".$_SERVER['HTTP_HOST'] . $pageArray['image']; ?>" />
<meta property="og:description" content="<?php echo $pageArray['description'] ?>" />
