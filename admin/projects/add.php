...
<div class="content-wrapper">
    <div class="container-fluid">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <a href="/admin/projects/index.php" class="btn btn-primary"><i class="fa fa-arrow-circle-left"></i>
                        Back</a>
                </div>
            </div>
                    ...
                    <div class="form-group">
                        <form>
                            ...
                            <div class="alert alert-warning" role="alert">
                                Les catégories sont gérées dans la partie article !
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10">
                                    <input class="form-control" type="date" name="date_project" value="2017-01-01" id="date">
                                </div>
                            </div>
...
// Returns successful data submission message when the entered information is stored in database.
            var dataString = 'type=' + type + '&title=' + title + '&subtitle=' + subtitle + '&contenu=' + editor + '&date_project=' + date + '&path=' + path + '&legend=' + legend + '&tags=' + arrayTagSerialized;
            if (type == '' || title == '' || subtitle == '' || editor1 == '' || date == '' || path == '' || legend == '' || arrayTagSerialized == '') {
                $.notify({
                    // options
