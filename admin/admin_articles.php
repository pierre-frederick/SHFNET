        ...
        <div class="row">
            <div class="form-group">
                <form enctype="multipart/form-data" action="../includes/insert.php" method="post">
                    ...
                    <label for="contenu">Contenu :</label> <textarea name="contenu" id="contenu" rows="10" cols="50"
        ...
        <table class="table table-striped">
            ...
            foreach ($articles as $article) { ?>
                <tr>
                    ...
                    <th><?php $date = strtotime($article['date']);
                        echo "Le " . date("d-m-Y", $date) . " à " . date("H:i", $date); ?></th>
                    ...
                    <th><a data-toggle="modal" data-target="#edit" class="btn btn-link btn-sm"
                           onclick="MakeModal(<?php echo $article['id']; ?>);"><span class="glyphicon glyphicon-edit"
                                                                                     aria-hidden="true"></span> Edit</a>
                    </th>
                    <th><a href="admin.php"> <span class="glyphicon glyphicon-remove" aria-hidden="true"></span></a>
                    </th>
                </tr>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <form enctype="multipart/form-data" action="../includes/insert.php" method="post">
                                <label for="title">Titre :</label> <input type="text" name="title" id="titlemodal"
                                                                          class="form-control" value=""/><br/>
                                <label for="subtitle">Sous-titre :</label> <input type="text" name="subtitle"
                                                                                  id="subtitlemodal"
                                                                                  class="form-control"/><br/>
                                <!--<label for="categorie">Catégorie :</label>
                                ...
                                <label for="contenu">Contenu :</label> <textarea name="contenu" id="contenumodal"
                                                                                 rows="10" cols="50"
                                                                                 class="form-control"> Contenu de l'article</textarea><br/>

                                <label for="auteur">Auteur :</label> <input type="text" name="auteur" id="auteurmodal"
                                                                            class="form-control"/><br/>

                                <!-- <input type="hidden" name="MAX_FILE_SIZE" value="250000" />
                                 <label for="fic">Image :</label>
                                 <input type="file" name="fic" size=50 /> <br /> -->
                                <label for="legende">Legende :</label> <input type="text" name="legende"
                                                                              id="legendemodal"
                                                                              class="form-control"/><br/>
                                <input type="submit" value="Envoyer" class="btn btn-primary"/>
                            </form>
